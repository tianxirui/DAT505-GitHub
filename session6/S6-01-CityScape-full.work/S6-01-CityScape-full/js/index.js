...
function setupThreeJS() {
  ...
  scene.fog = new THREE.FogExp2(0x9db3b5, 0.02);//雾
  ...
  renderer.setClearColor(0xE8E5E0, 1);//背景色
...
function setupWorld() {
  ...
  var material = new THREE.MeshPhongMaterial({overdraw: true, color: 0xFBF9F7,wireframe:true});//线框颜色
  ...
  for (var i = 0; i < 300; i++) {
    ...
    building.scale.y  = building.scale.x;//正方形线框
